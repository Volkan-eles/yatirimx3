...
const data = [
  { name: '16 Kas', value: 11.55 },
  { name: '19 Kas', value: 11.58 },
  { name: '22 Kas', value: 11.68 },
  { name: '25 Kas', value: 11.45 },
  { name: '28 Kas', value: 11.60 },
  { name: '1 Ara', value: 11.75 },
  { name: '3 Ara', value: 11.65 },
  { name: '5 Ara', value: 11.72 },
  { name: '7 Ara', value: 11.80 },
  { name: '9 Ara', value: 11.76 },
  { name: '12 Ara', value: 11.85 },
  { name: '15 Ara', value: 11.90 },
];

const StockChart = ({ color = "#3b82f6" }: { color?: string }) => {
  return (
